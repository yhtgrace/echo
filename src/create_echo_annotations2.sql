...
--  OWNER TO postgres;
COPY mimiciii.echo_annotations_unique FROM '/Users/yhtgrace/projects/echo/teemo/resources/echo_annotations_March2017/echo_2017-03-03-13-03-46-354000_modified.txt' CSV HEADER;
--COPY mimiciii.echo_annotations_unique FROM '/path/to/echo_2017-03-03-13-03-46-354000_modified.txt' CSV HEADER;
